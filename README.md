...
<p>Dilation: Extend white regions to merge nearby digits together, allowing machine to detect with digits belong together in a term. This gives meaning to the numbers. Pixels are dilated with a kernel (see below); to identify terms, a kernel with a large width is ideal incase digits are spaced out.</p>
